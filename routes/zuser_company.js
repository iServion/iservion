...
var MYMODEL = require('./../models/zuser_company');


var users = async() => {
    return [Util.arrayUnShift(['id', 'name']), ... await connection.results({
...
router.post('/list', async (req, res) => {
        var relations = await zRoute.relations(req, res, MYMODEL.table);
    relations["user_id"] = await users();
    relations["user_idObject"] =  Util.arrayWithObject(relations["user_id"], 'id', 'name');
    var body = req.body;
